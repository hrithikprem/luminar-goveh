...
<body>
	...
	<form name="preport" method="GET" action="purchaseReport">

	
	FROM<br><input type="date" id="myDate" name="fromDate"><br><br>
	TO<br><input type="date" id="myDate" name="toDate"><br><br>
