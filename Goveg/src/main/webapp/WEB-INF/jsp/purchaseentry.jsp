	...
	<nav class="navbar">
		...
		<div class="formSection">
				<form  method="post" action="purchase">
					Farmer Id<input type="number" name="famid"><br>
					Item Name<input type="text" name="itemName"><br>
					Item Price<input type="number" id="price" name="itemPrice" step="0.01" min="0.00" required><br>
					Item Quantity<input type="number" id="price" name="itemQty" step="0.01" min="0.00" required><br><br>
					Date        <input type="date" id="myDate" name="myDate"><br><br>
